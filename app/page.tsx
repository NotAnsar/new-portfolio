	...
	return (
		<div className='space-y-16'>
			...
			<section className='flex flex-col items-center text-center space-y-6 py-12'>
				<div className='w-32 h-32 rounded-full bg-gradient-to-br from-primary to-primary-background/85 mb-4 flex items-center justify-center'>
					{/* Replace with your actual profile image */}
					<span className='text-4xl text-primary-foreground font-bold'>AK</span>
				</div>

				<div className='space-y-4'>
					<h1 className='text-4xl md:text-5xl font-bold tracking-tight'>
						Hi, I'm{' '}
						<span className='text-primary font-black'>Ansar Karrouach</span>
					</h1>
					...
					<p className='text-lg text-muted-foreground max-w-2xl leading-relaxed'>
						...
						TypeScript, and Spring Boot. Experienced in building scalable apps,
						connecting modern frontends with robust Java backends.
					</p>
				</div>
